...
export default ({
  ...
  description = "Hey there, We are are made for kritash and solve the problems for kritash, here are the some of the most asked questions and its answers",
  faqs = [
    {
      question: "Can i post my own blog to kritash Blogs ?",
      answer:
        "Yes, you can publish your blogs on kritash site, but for this you will have to go through some procedures, for that feelfree to contact as at kritashiitjammu@gmail.com"
    },
    {
      question: "Can an individual fund kritash to do an Event for Social Welfare ?",
      answer:
        "As kritash has its identity of doing social welfare ,you're welcome to contribute us in this Journey"
    },
    {
      question: "Is it an Independent organisation ?",
      answer:
        "Yes it is, And run by student body of indian institue of technology"
    },
    {
      question: "What is the motive of this Society ?",
      answer:
        "To help the society"
    },
