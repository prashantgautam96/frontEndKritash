...
export default ({
  subheading = "Our Movement",
  heading = (
    <>
      Designed & Developed by <span tw="text-primary-500">Professionals.</span>
    </>
  ),
  description = "Blood donation can be described as a prosocial behavior, and donors often cite prosocial reasons such as altruism, empathy, or social responsibility for their willingness to donate. ... The largest differences in prior donations were by age and donor status, with older and current donors having given more frequently.",
  primaryButtonText = "Register",
  primaryButtonUrl = "/blooddatabase",
  ...
  const defaultFeatures = [
    {
      ...
      description: "It can be usefull to you,friends and family",
      iconContainerCss: tw`bg-teal-300 text-teal-800`
    },
    {
      Icon: MoneyIcon,
      title: "Secure",
      description: "We promise to not share your information, - and contact when a person is needy for it.",
