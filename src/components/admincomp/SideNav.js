...
<aside className="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" className="brand-link">
    ...
    <span className="brand-text font-weight-light">Kritash IIT Jammu</span>
  </a>
  {/* Sidebar */}
  <div className="sidebar">
    ...
    <div className="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div className="info">
        <a href="#" className="d-block">Social Admin</a>
      </div>
    </div>
    {/* SidebarSearch Form */}
    ...
    <nav className="mt-2">
      <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li className="nav-item menu-open">
          <a href="/blogging" className="nav-link active">
        ...
        <li className="nav-item">
          <a href="/Allblogs" className="nav-link">
        ...
        <li className="nav-item">
          ...
          <ul className="nav nav-treeview">
            <li className="nav-item">
              <a href="/Allteam" className="nav-link">
                <i className="far fa-circle nav-icon" />
                <p>Current Team</p>
              </a>
            </li>
            <li className="nav-item">
              <a href="/Alltime" className="nav-link">
                <i className="far fa-circle nav-icon" />
                <p>All Time Teams</p>
              </a>
            </li>
        ...
        <li className="nav-item">
          ...
          <ul className="nav nav-treeview">
            <li className="nav-item">
              ...
              <a href="/bloodData" className="nav-link">
            ...
            <li className="nav-item">
              <a href="/contactData" className="nav-link">
                <i className="far fa-circle nav-icon" />
                <p>Contact Us</p>
              </a>
            </li>
